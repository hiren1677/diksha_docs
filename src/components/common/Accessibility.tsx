      ...
      <div className="top-header">
        <Container>
          <Row className="d-flex align-items-center">
            <Col md={4} className="d-flex government-of-india">
              <img src="https://obj.diksha.gov.in/ntp-content-production/homepage/prod/diksha-mission/Flag_of_India.svg" className="me-2" width="24" alt="भारत सरकार | Government of India" /> 
              <span>{getText('common.governmentOfIndia', 'Government of India')}</span>
            </Col>
            <Col md={8}>
              <div className="top-header-right">
                <ul className="navigation-links">
                  {/* <li>
                    <a href="">{getText('accessibility.skipToMainContent', 'Skip to Main Content')}</a>
                  </li>
                  <li>
                    <a href="">
                      <img src="images/icon_screen_reader.png" className="me-1" alt="" />
                      {getText('accessibility.screenReader', 'Screen Reader')}
                    </a>
                  </li> */}
                  <li>
                    <a href="">{getText('accessibility.siteMap', 'Site Map')}</a>
                  </li>
                  <li>
                    <div className="fontresize">
                      <Button variant="link">{getText('accessibility.fontSizeDecrease', 'A-')}</Button>
                      <Button variant="link">{getText('accessibility.fontSizeNormal', 'A')}</Button>
                      <Button variant="link">{getText('accessibility.fontSizeIncrease', 'A+')}</Button>
                    </div>
                  </li>
                  <li>
                    <Button 
                      ...
                      variant="link"
                      title={getText('accessibility.darkModeToggle', 'Dark mode/Normal mode')}
                    >
                      <svg width="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 496">
                        <path 
                          fill="#ebebeb" 
